    ...
    <div className="mt-16 pb-16 px-4 md:px-8 max-w-7xl mx-auto w-full">
      ...
      {orders.map((order) => {
        ...
        return (
          <div
            key={id}
            className="border border-gray-200 shadow-sm rounded-lg p-4 md:p-6 mb-10 w-full"
          >
            ...
            {items?.map((item, index) => {
              ...
              return (
                <div
                  ...
                  } flex flex-col md:flex-row md:items-center justify-between py-5 gap-4 md:gap-8 w-full`}
                >
